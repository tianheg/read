...
export function sidebarNonBook() {
  return [
    {
      text: "张云帆与芒格",
    ...
    },
    {
      ...
      link: "building-programmable-web-sites",
    },
    {
      text: "Art is useless, and so am I",
      link: "art-is-usefull-so-am-i",
    },
    {
      text: "全面理解机器智能与生成式AI加速的新工业革命",
      link: "understanding-genai-and-the-new-industrial-revolution",
    },
    {
      text: "Hacker News Guidelines",
      link: "hacker-news-guidelines",
    },
    {
      text: "王小伟：一个哲学视角的日常审查",
      link: "wang-xiaowei-zhexue-richang-shencha",
    },
    {
      text: "So you sucks, now what?",
      link: "so-you-sucks-now-what",
    },
    {
      text: "You're a shit",
      link: "you-re-a-shit",
    },
    {
      ...
      link: "how-to-learn-stuff-quickly",
    },
    {
      text: "Write for others but mostly for yourself",
      link: "write-for-others-but-mostly-for-yourself",
    },
    {
      text: "Let's learn how modern JavaScript frameworks work by building one",
      link: "lets-learn-how-modern-javascript-frameworks-work-by-building-one",
    },
    {
      text: "History of Psychology",
      link: "history-of-psychology",
    },
  ];
}
